package com.example.a24168.myapplication.course.commentDiaolg.widget;
...
import com.example.a24168.myapplication.course.commentDiaolg.util.SizeUtils;
        ...
        if (!TextUtils.isEmpty(atSomeone)) {
            ...
            builder.setSpan(new TextClickSpans() {
                ...
                public void onClick(@NonNull View widget) {
                    Toast.makeText(MyApplication.getApplication(), atSomeone + " id: " + id, Toast.LENGTH_LONG).show();
                }
