...
public class Adapter extends BaseAdapter {
    ...
    public Adapter(List<Type> list, Context context, int id) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        RelativeLayout relativeLayout = convertView.findViewById(R.id.rela);
    ...
    public void allSort(){
        Intent intent = new Intent();
        intent.setClass(fragment, AllSort.class);
        context.startActivity(intent);
        fragment.overridePendingTransition(R.anim.anim_in_right,R.anim.anim_out_left);
