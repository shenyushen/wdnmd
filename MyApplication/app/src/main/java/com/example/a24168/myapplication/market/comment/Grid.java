 ...
 * data：16/7/27
 */
public class Grid extends RecyclerView.Adapter<Grid.ViewHolder> {
    ...
    public Grid(Context context, onAddPicClickListener mOnAddPicClickListener) {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        ViewHolder(View view) {
            super(view);
            mImg = view.findViewById(R.id.fiv_s);
            ll_del = view.findViewById(R.id.ll_del_s);
            tv_duration = view.findViewById(R.id.tv_duration_s);
        }
    }
    ...
    public ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        View view = mInflater.inflate(R.layout.item_filter_image_s, viewGroup, false);
